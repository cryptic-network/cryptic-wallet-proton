...
export const directories = [
  `${homedir}/.crypticwallet`,
  `${homedir}/.crypticwallet/logs`
];
...
log.debug(`Cryptic wallet started...`);
  ...
  const message = (
    <div>
      ...
      <p className={`subtitle ${textColor}`}>
        There&apos;s a new version of Cryptic Wallet available. Would you
        like to download it?
      </p>
    </div>
  );
...
function handleAbout() {
  remote.shell.openExternal(
    'http://github.com/cryptic-network/cryptic-wallet-proton#readme'
  );
}
...
function handleIssues() {
  remote.shell.openExternal(
    'https://github.com/cryptic-network/cryptic-wallet-proton/issues'
  );
}
